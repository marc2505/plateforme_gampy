...
class UpdateTerrainStep3 extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            // PHOTOS
            'images_principales' => 'nullable|array',
            'images_principales.*' => 'nullable|file',
            'images_cadres' => 'nullable|array',
            'images_cadres.*' => 'nullable|file',
            'images_autres' => 'nullable|array',
            'images_autres.*' => 'nullable|file',
            // ADRESSE
